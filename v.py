...
#---------------—------------———----------------
            if IDMODSKIN[:3] == '521':
                ...
                with open(file_path, 'wb') as f:
                    f.write(rpl)
#---------------—------------———----------------
            #if IDMODSKIN == '14111' and 'S1.xml' not in file_path and 'S1B1.xml' not in file_path and 'S1B2.xml' not in file_path and 'S1B11.xml' not in file_path and 'S1B12.xml' not in file_path and 'S1B21.xml' not in file_path and 'S1B22.xml' not in file_path:
...
#-----------------------------------------------
    IDNODMODCHECK = ['13210', '16707', '13011', '52414', '15015', '15013', '13314', '13706','59901','13213','11215','59802','10915','15412','10611','10620']
...
b'        <int name="skinId" value="' + IDCHECK.encode() + b'" refParamName="" useRefParam="false" />\r\n        <bool name="bEqual" value="false" refParamName="" useRefParam="false" />')
    ...
    for file in os.listdir(Kiem_Tra_Code):
        ...
        if IDMODSKIN == '10915' and 'PSE.xml' in file:
            with open(File_Check_Code, "rb") as f: rpl = f.read().replace(b'10915_Wusuxie',b'10915/10915_Wusuxie')
            with open(File_Check_Code, "wb") as f:
                f.write(rpl)
